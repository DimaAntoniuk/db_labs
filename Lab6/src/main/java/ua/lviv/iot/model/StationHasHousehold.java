...
@IdClass(StationHasHouseholdPK.class)
public class StationHasHousehold {
    private int stationId;
    private int householdId;

    public StationHasHousehold() {

    }

    public StationHasHousehold(int stationId, int householdId) {
    ...
    public boolean equals(Object o) {
        ...
        StationHasHousehold that = (StationHasHousehold) o;
